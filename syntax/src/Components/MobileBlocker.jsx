...
export default function MobileBlocker({ children }) {
    ...
    useEffect(() => {
        const checkMobile = () => {
            // Check user agent for mobile devices (works even with desktop mode)
            ...
            // iPad on iOS 13+ reports as MacIntel, detect via maxTouchPoints
            const isIPad = navigator.maxTouchPoints > 1 && /Mac/i.test(navigator.userAgent);

            // Consider it mobile if user agent indicates mobile device or it's an iPad
            const mobile = mobileUserAgent || isIPad;
            ...
            <>
                ...
                <div className="mobile-blocker">
                    ...
                    <div className="mobile-blocker-hint">
                        ...
                        <span>Please use a computer</span>
                    </div>
                </div>
            </>
        );
